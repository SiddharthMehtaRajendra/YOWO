...
def parse_opts():
    ...
    parser.add_argument('--end_epoch', default=7, type=int, help='Training ends at this epoch.')
    ...
    parser.add_argument('--backbone_3d', default='resnet50', type=str, help='(resnext101 | resnet101 | resnet50 | resnet18 | mobilenet_2x | mobilenetv2_1x | shufflenet_2x | shufflenetv2_2x')
